...
SELECT rental_duration * rental_rate AS total_rental_cost FROM film;
...
-- not sure which is correct. Results differ.
...
-- # 9a. Select customer first_name/last_name and actor first_name/last_name columns from performing a left join between the customer 
...
WHERE TABLE_NAME = N'staff'; -- <-- This string is the table to crawl.
